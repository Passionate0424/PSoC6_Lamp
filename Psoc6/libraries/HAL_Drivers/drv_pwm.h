...
#endif /* PWM0_CH0_PORT0_CONFIG */

#ifndef PWM0_CH0_PORT10_CONFIG
#define PWM0_CH0_PORT10_CONFIG       \
    {                               \
        .name = "pwm0",             \
        .channel = 0,               \
        .gpio = GET_PIN(10, 4),      \
    }
#endif /* PWM0_CH0_PORT10_CONFIG */
...
#ifdef BSP_USING_PWM0
#ifndef PWM1_CH0_PORT10_COMPL_CONFIG
#define PWM1_CH0_PORT10_COMPL_CONFIG \
    {                               \
        .name = "pwm1",             \
        .channel = 0,               \
        .gpio = GET_PIN(10, 5),      \
    }
#endif /*PWM1_CH0_PORT10_COMPL_CONFIG*/
