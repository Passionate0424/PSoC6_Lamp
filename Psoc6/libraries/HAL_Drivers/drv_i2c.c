...
void HAL_I2C_Init(struct ifx_i2c *obj)
{
    ...
    /* 首先释放GPIO资源，然后配置为SCB资源 */
        /* 释放GPIO资源 */
        cyhal_resource_inst_t resource_p9_0 = {CYHAL_RSC_GPIO, 9, 0};
        cyhal_resource_inst_t resource_p9_1 = {CYHAL_RSC_GPIO, 9, 1};
        cyhal_hwmgr_free(&resource_p9_0);
        cyhal_hwmgr_free(&resource_p9_1);

//        /* 预留SCB资源 - SCB2适用于P9.0/P9.1的I2C功能 */
//        cyhal_resource_inst_t scb_resource = {CYHAL_RSC_SCB, 2, 0}; // SCB2, 通道0
//        result = cyhal_hwmgr_reserve(&scb_resource);
//        if (result != CY_RSLT_SUCCESS)
//        {
//            rt_kprintf("reserve SCB2 resource failed!\n");
//            return;
//        }
