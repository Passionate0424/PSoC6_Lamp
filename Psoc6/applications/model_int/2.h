...
#define DENSE_2_OUTPUT_RSHIFT {5}
...
#define TENSOR_DENSE_3_BIAS_0 {8, 7, 0, 5, 1, 8, -23, -4, -16, 7, 5, 3, 3, -3, -1, 0}

#define TENSOR_DENSE_3_BIAS_0_DEC_BITS {4}
...
#define TENSOR_DENSE_4_BIAS_0 {-10, -15, -1, 11, -1, -11, -11, 2, 0, 9, 6, -1}

#define TENSOR_DENSE_4_BIAS_0_DEC_BITS {4}
...
#define DENSE_7_BIAS_LSHIFT {3}

#define DENSE_7_OUTPUT_RSHIFT {4}
...
#define DENSE_6_OUTPUT_DEC 5
#define DENSE_6_OUTPUT_OFFSET 0
#define RE_LU_6_OUTPUT_DEC 5
