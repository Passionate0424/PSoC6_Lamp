...
C_SRCS += \
../packages/onnx-backend-latest/src/add.c \
../packages/onnx-backend-latest/src/conv2d.c \
../packages/onnx-backend-latest/src/dense.c \
../packages/onnx-backend-latest/src/info.c \
../packages/onnx-backend-latest/src/matmul.c \
../packages/onnx-backend-latest/src/maxpool.c \
../packages/onnx-backend-latest/src/model.c \
../packages/onnx-backend-latest/src/relu.c \
../packages/onnx-backend-latest/src/softmax.c \
../packages/onnx-backend-latest/src/transpose.c 

OBJS += \
./packages/onnx-backend-latest/src/add.o \
./packages/onnx-backend-latest/src/conv2d.o \
./packages/onnx-backend-latest/src/dense.o \
./packages/onnx-backend-latest/src/info.o \
./packages/onnx-backend-latest/src/matmul.o \
./packages/onnx-backend-latest/src/maxpool.o \
./packages/onnx-backend-latest/src/model.o \
./packages/onnx-backend-latest/src/relu.o \
./packages/onnx-backend-latest/src/softmax.o \
./packages/onnx-backend-latest/src/transpose.o 

C_DEPS += \
./packages/onnx-backend-latest/src/add.d \
./packages/onnx-backend-latest/src/conv2d.d \
./packages/onnx-backend-latest/src/dense.d \
./packages/onnx-backend-latest/src/info.d \
./packages/onnx-backend-latest/src/matmul.d \
./packages/onnx-backend-latest/src/maxpool.d \
./packages/onnx-backend-latest/src/model.d \
./packages/onnx-backend-latest/src/relu.d \
./packages/onnx-backend-latest/src/softmax.d \
./packages/onnx-backend-latest/src/transpose.d 


# Each subdirectory must supply rules for building sources it contributes
packages/onnx-backend-latest/src/%.o: ../packages/onnx-backend-latest/src/%.c
	-@echo compiling $<...
